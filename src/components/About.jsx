          ...
          <section id="perfil" className="mt-12 mb-12">
            <div className="flex flex-col md:flex-row items-center gap-6 justify-evenly pb-6">
              {/* <img
                ...
                className="w-42 h-42 sm:w-80 sm:h-80 rounded-full object-cover 80 shadow mb-4 md:mb-0 md:ml-6 order-1 md:order-2 animate-fade-up animate-duration-[5000ms] animate-delay-100 animate-ease-in-out"
              /> */}

              <img
                src={perfil}
                alt="Foto de Jocely Marques"
                className="w-42  sm:w-auto sm:h-full  object-cover 80 shadow mb-4 md:mb-0 md:ml-6 order-1 md:order-2 animate-fade-up animate-duration-[5000ms] animate-delay-100 animate-ease-in-out"
              />
              <div className="flex flex-col order-2 md:order-1">
                <h1 className="w-full font-bold text-3xl sm:text-7xl text-center sm:text-left text-green-500/80 mb-10 animate-fade-up animate-duration-[1000ms] animate-delay-100 animate-ease-in-out">
                  Jocely Marques
                </h1>
                <p className="text-2xl text-justify text-gray-500 max-w-lg mb-5 animate-fade-up animate-duration-[2000ms] animate-delay-100 animate-ease-in-out">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="inline-flex w-fit items-center rounded-full bg-green-500/80/20 px-2 py-1 text-xs font-medium text-gray-400">
                    Reactjs
                  </span>
                  <span className="inline-flex w-fit items-center rounded-full bg-green-500/80/20 px-2 py-1 text-xs font-medium text-gray-400">
                    Laravel
                ...
                <div className="flex flex-wrap gap-4 mt-6">
                  ...
                  <a
                    href="/CV_BR_Francisco_Jocely_Dias_Marques_DEV_TI.pdf" download
